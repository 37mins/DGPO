...
do
    ...
    --n_rollout_threads 100 --n_eval_rollout_threads 48 --eval_interval 80 --episode_length 200 \
    --num_mini_batch 16 --num_env_steps 16000000 --use_ReLU \
    --entropy_coef 0.0 --gamma 0.99 0.99 \
    --max_z 2 --div_thresh 1.1 --rex_thresh -2.5 --discri_lr 1e-4 --alpha_lr 0. \
    --wandb_name "cwz19" --user_name "cwz19" --log_interval 5 --eval_interval 80 \
    --use_eval --use_wandb
done