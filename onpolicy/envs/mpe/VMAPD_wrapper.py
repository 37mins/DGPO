...
class VMAPDWrapper(gym.Wrapper):
    ...
    def __init__(self, env, max_z, fix_z):
        ...
        self.z_obs_space = [copy.deepcopy(self.share_observation_space[i]) for i in range(self.num_agents)]
        self.z_local_obs_space = [copy.deepcopy(self.observation_space[i]) for i in range(self.num_agents)]
